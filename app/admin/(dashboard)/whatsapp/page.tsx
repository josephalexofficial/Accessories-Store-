...
export default async function AdminWhatsAppPage() {
  ...
  return (
    <div className="space-y-8">
      <h1 className="text-2xl font-bold text-foreground">WhatsApp Interaction Log</h1>

      <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
        <Card>
          <CardContent className="p-6">
            <p className="text-xs uppercase text-muted">Most Wanted Product</p>
            <p className="mt-2 font-bold text-foreground">{topProduct?.title ?? "—"}</p>
        ...
        <Card>
          <CardContent className="p-6">
            ...
            <p className="mt-2 font-bold text-foreground">{totalClicks} Total Clicks</p>
          </CardContent>
        </Card>
      </div>
